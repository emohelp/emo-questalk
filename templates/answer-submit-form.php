...
<div class="emqa-answer-form">
	...
	<div class="emqa-answer-form-title"><?php _e( 'Your Answer', 'emqa' ) ?></div>
	<form name="emqa-answer-form" id="emqa-answer-form" method="post" enctype="multipart/form-data">
		...
		<p>
			<label for="user-email"><?php _e( 'Your Email', 'emqa' ) ?></label>
		...
		<p>
			<label for="user-name"><?php _e( 'Your Name', 'emqa' ) ?></label>
		...
		<input type="submit" name="submit-answer" class="emqa-btn emqa-btn-primary" value="<?php _e( 'Submit', 'emqa' ) ?>">
